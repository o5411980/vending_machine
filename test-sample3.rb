...
class PurchaseAndReturn < VendingMachine
  def purchase_cola_and_return #vm=PurchaseAndReturn.newして、vm.purchase_cola_and_return で cola購入 & 返金
    purchase_cola
    return_money
  end

  def purchase_redbull_and_return #vm=PurchaseAndReturn.newして、vm.purchase_redbull_and_return
    purchase_redbull
    return_money
  end

  def purchase_water_and_return #vm=PurchaseAndReturn.newして、vm.purchase_water_and_return
    purchase_water
    return_money
  end
end
